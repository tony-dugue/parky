...
export const majorCitiesLocationInfo: LocationInfo[] = [
  { placeName: 'Chennai, Tamil Nadu, India', latLng: [13.0827, 80.2707] },
  {
  ...
  { placeName: 'Paris, France', latLng: [48.8566, 2.3522] },
  { placeName: 'Berlin, Germany', latLng: [52.52, 13.405] },
  {
    placeName: 'Sydney, New South Wales, Australia',
    latLng: [-33.8688, 151.2093],
  },
  { placeName: 'Rio de Janeiro, Brazil', latLng: [-22.9068, -43.1729] },
  {
